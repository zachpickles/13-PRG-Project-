...
class StartScreen():    #Declares Starting class 
    def __init__(self):     #Initialises Output (First function to always run)
        ...
        InstTitle = tk.Label(self.root, text="INSTRUCTIONS", bg="#cceae3", font="Arial 14",width=15,height=2 ,borderwidth=1, relief="solid").place(x=10, y=340)     
        Inst = tk.Label(self.root, text="This will be a 10 question quiz made\nup of true/false and multiple choice\nquestions. You will be given a NCEA grade.\nYou can only skip 3 times", bg="#cceae3", font="Arial 12",width=35,height=5,borderwidth=1, relief="solid").place(x=10, y=390)
        self.root.mainloop()
